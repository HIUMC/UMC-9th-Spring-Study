...
public class MemberMissionController implements MemberMissionControllerDocs{
    ...
    public ApiResponse<MemberMissionResDto.PreviewDto> createMemberMission(
    ...
    @PatchMapping("/users/missions/{memberMissionId}")
    @Override
    public ApiResponse<MemberMissionResDto.PreviewDto> updateMemberMission(

...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = -1192557362L;
    ...
    public final HongikSpring.demo.member.QMember member;

    public final HongikSpring.demo.mission.QMission mission;
    ...
    public QMemberMission(Class<? extends MemberMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new HongikSpring.demo.member.QMember(forProperty("member")) : null;
        this.mission = inits.isInitialized("mission") ? new HongikSpring.demo.mission.QMission(forProperty("mission")) : null;
    }
